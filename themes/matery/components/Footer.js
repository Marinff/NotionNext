...
const Footer = ({ title }) => {
  ...
  return (
    <footer className='relative z-10 dark:bg-black flex-shrink-0 bg-indigo-100 text-gray-300 justify-center text-center m-auto w-full leading-6  dark:text-gray-100 text-sm p-6'>
      {/* <DarkModeButton/> */}
