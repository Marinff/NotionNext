  ...
  return (
    <>
      <div
        onClick={toggleShow}
        className={
          'py-2 px-5 duration-300 text-base justify-between hover:bg-white hover:text-black hover:shadow-lg cursor-pointer font-light flex flex-nowrap items-center ' +
          (selected
