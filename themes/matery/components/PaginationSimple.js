    ...
    <div className="my-10 mx-6 flex justify-between font-medium text-black dark:text-gray-100 space-x-2">
      <Link
        ...
        <button
          rel="prev"
          className={`${
            currentPage === 1 ? 'opacity-20  bg-gray-200  text-gray-500 pointer-events-none ' : 'block text-black bg-white'
      ...
      <Link
        ...
        <button
          rel="next"
          className={`${
            +showNext ? 'text-black bg-white ' : ' opacity-20 bg-gray-200 text-gray-500 pointer-events-none '
